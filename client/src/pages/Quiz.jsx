...
// confirm the rail persists across tools. Real quiz generation needs a backend
// route and comes later.
function Quiz() {
  ...
  return (
    <main className="flex min-h-0 flex-1 flex-col items-center justify-center px-8 text-center">
      ...
      <p className="mt-6 max-w-md text-cream/60">
        {activeCourse
          ? `${documents.length} document${documents.length === 1 ? "" : "s"} ready. Quiz generation is coming soon.`
